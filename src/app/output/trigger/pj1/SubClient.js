    ...
    <>
      ...
      <div className="p-4 flex items-center justify-between">
        ...
        <div>
          <button
            type="button"
            aria-label="앱 다운로드"
            className="flex flex-col justify-center items-center w-[80px] h-[80px] rounded-xl border border-gray-200 shadow-xl"
          >
            <svg
              width="23"
              height="36"
      ...
      <section className="py-12">
        <div className="relative py-12 perspective-normal mx-auto w-2/3 text-white max-lg:w-5/6">
          <div
            ref={animation11Ref}
            className="sticky top-[100px] p-12 w-full h-[400px] flex justify-between items-center origin-top rotate-x-0 rounded-xl text-left leading-[1.2] bg-blue-700  max-2xl:flex-col max-2xl:justify-center"
          >
          ...
          <div
            ref={animation12Ref}
            className="sticky top-[120px] p-12 w-full h-[400px] flex justify-between items-center origin-top rotate-x-0 rounded-xl text-left leading-[1.2] bg-violet-600 max-2xl:flex-col max-2xl:justify-center"
          >
          ...
          <div
            ref={animation13Ref}
            className="sticky top-[140px] p-12 w-full h-[400px] flex justify-between items-center origin-top rotate-x-0 rounded-xl text-left leading-[1.2] bg-orange-600 max-2xl:flex-col max-2xl:justify-center"
          >
          ...
          <div
            ref={animation14Ref}
            className="sticky top-[160px] p-12 w-full h-[400px] flex justify-between items-center origin-top rotate-x-0 rounded-xl text-left leading-[1.2] bg-indigo-600 max-2xl:flex-col max-2xl:justify-center"
          >
            <p className="mb-10 paperlogy-bold text-6xl">
              당신의 코인을 안전하게
            </p>
